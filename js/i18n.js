const translations = {
  ar: {
    ...
    // ===== لوحة الإدارة المطوّرة =====
    statTotalShops: "إجمالي المحلات",
    statActiveShops: "محلات نشطة",
    statTrialShops: "فترة تجريبية",
    statExpiredShops: "منتهية/معلّقة",
    statPendingPayments: "دفعات بانتظار التأكيد",
    statMRR: "إيرادات شهرية متوقعة",
    searchShopsPlaceholder: "ابحث باسم المحل أو إيميل المالك...",
    filterAll: "الكل",
    filterTrial: "فترة تجريبية",
    filterActive: "نشط",
    filterExpired: "منتهي",
    ...
    suspendBtn: "تعليق",
    reactivateBtn: "إلغاء التعليق",
    confirmSuspend: "تعليق هذا المحل يمنع صاحبه من الوصول للتطبيق فوراً. متأكد؟",
    confirmReactivate: "إلغاء تعليق هذا المحل يعيد له الوصول فوراً. متأكد؟",
    shopSuspended: "تم تعليق المحل",
    shopReactivated: "تم إلغاء التعليق",
    viewDetails: "تفاصيل",
    detailClients: "عملاء",
    detailRepairs: "طلبات",
    detailParts: "قطع مخزون",
    noShopsFound: "لا توجد محلات مطابقة للبحث",

    // ===== شاشة قفل المحل المعلّق =====
  ...
  fr: {
    ...
    statTotalShops: "Total des ateliers",
    statActiveShops: "Ateliers actifs",
    statTrialShops: "Période d'essai",
    statExpiredShops: "Expirés/suspendus",
    statPendingPayments: "Paiements en attente",
    statMRR: "Revenu mensuel estimé",
    searchShopsPlaceholder: "Rechercher par nom d'atelier ou email...",
    filterAll: "Tous",
    filterTrial: "Essai",
    filterActive: "Actif",
    ...
    confirmSuspend: "Suspendre cet atelier bloque immédiatement l'accès du propriétaire. Confirmer ?",
    confirmReactivate: "Réactiver cet atelier lui redonne l'accès immédiatement. Confirmer ?",
    shopSuspended: "Atelier suspendu",
    shopReactivated: "Suspension levée",
    viewDetails: "Détails",
    detailClients: "clients",
    detailRepairs: "demandes",
    detailParts: "pièces",
    noShopsFound: "Aucun atelier ne correspond à la recherche",
